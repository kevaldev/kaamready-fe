            ...
            <div className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="col-span-2">
                  ...
                  <p className="mt-1 text-base text-gray-900">
                    {workerProfile.address}, {workerProfile.city},{" "}
                    {workerProfile.state} - {workerProfile.pincode}
                  </p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">
                    {t("worker.idProofType")}
                  </p>
                  <p className="mt-1 text-base text-gray-900">
                    {
                      idProofOptions.find(
                        (option) => option.value === workerProfile.idProofType
                      )?.label
                    }
                  </p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">
                    {t("worker.idProofNumber")}
                  </p>
                  <p className="mt-1 text-base text-gray-900">
                    {workerProfile.idProofNumber}
                  </p>
                </div>
                <div className="col-span-2">
                  <p className="text-sm font-medium text-gray-500">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-base text-gray-900">
                      ...
                      {workerProfile.experienceYears === 1
                        ? t("worker.year")
                        : t("worker.years")}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-gray-500">
                      {t("worker.skills.label")}
                    </p>
                    <div className="mt-1 flex flex-wrap gap-2">
                      {workerProfile.skills.map((skill) => (
                        <span
                          key={skill}
                          className="px-2 py-1 bg-primary-50 text-primary rounded-full text-sm"
                        >
                          {
                            skillOptions.find(
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-500">
                      {t("worker.serviceCategories.label")}
                    </p>
                    <div className="mt-1 flex flex-wrap gap-2">
        ...
        <div className="mt-4 space-y-4">
          ...
          <div className="flex items-center justify-between py-3 border-b">
            <div>
              ...
              <p className="text-sm text-gray-500">
                {t("worker.addressProofDescription")}
              </p>
            </div>
